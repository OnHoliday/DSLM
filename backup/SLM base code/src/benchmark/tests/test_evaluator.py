...
class TestAlgorithm(unittest.TestCase):
    ...
    def test_evaluator_slm(self):
        evaluator_slm = EvaluatorSLM(SLM_OLS_CONFIGURATIONS, self.training,
    ...
    def test_evaluator_neat(self):
        evaluator_neat = EvaluatorNEAT(NEAT_CONFIGURATIONS, self.training,
                                       self.validation, self.testing, RootMeanSquaredError)
